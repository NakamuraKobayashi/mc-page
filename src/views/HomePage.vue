    ...
    >
      <div class="py-4 space-y-4">
        ...
        <p class="font-medium text-center md:text-left text-xl text-black dark:text-white">
          ...
          >
            mc.anikenji.xyz</span
          >
        </p>
        <p class="my-2 lg:text-xl md:leading-normal text-gray-900 dark:text-neutral-300">
          Support all version from 1.8 to 1.21+ <br>
          You can register account now by <a href="https://mc-dash.anikenji.xyz/auth_website/" class="register_link">CLICK HERE</a>
        </p>
      </div>
      <div>
        <!-- <video
